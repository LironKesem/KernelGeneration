...
def call(args):
    ...
    assert_size_stride(arg1_1, (K, N), (N, 1))
    with torch.cuda._DeviceGuard(0):
        torch.cuda.set_device(0)
        buf0 = empty_strided_cuda((M, K), (K, 1), torch.bfloat16)
        get_raw_stream(0)
        num_elements0 = arg0_1.numel()
