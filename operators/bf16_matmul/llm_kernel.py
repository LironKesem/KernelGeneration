...
def call(args):
    ...
    with torch.cuda._DeviceGuard(0):
        ...
        triton_poi_fused__to_copy_0[grid0](arg0_1, buf0, 65536,
        ...
        triton_poi_fused__to_copy_0[grid1](arg1_1, buf1, 8192, XBLOCK=
            256, num_warps=4, num_stages=1)
        del arg1_1
        buf2 = empty_strided_cuda((256, 32), (32, 1), torch.bfloat16) # bug: it was torch.float32
